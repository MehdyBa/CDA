<template>
    <div class="container-xxl justify-content-center">
      <svg id="background-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080" preserveAspectRatio="none">
      <g id="home">
  <defs>
...
.link {
  ...
  text-decoration: none;
  background-color: #00000000; /* Set your desired background color here */
...
<script>
  ...
  document.getElementById("inputPassword5").classList.remove("is-invalid", "is-valid");
  document.getElementById("emailError").textContent = "";
  document.getElementById("passwordError").textContent = "";

  // Valider l'email (exemple de validation simple)
  if (!email) {
  ...
  // Valider le mot de passe (exemple de validation simple)
  if (!password) {
    document.getElementById("passwordError").textContent = "Password is required.";
    document.getElementById("inputPassword5").classList.add("is-invalid");
    return false; // Empêche la soumission du formulaire
  } else {
    document.getElementById("inputPassword5").classList.add("is-valid");
  }
  ...
  // document.getElementById("myFormSignIN").submit();
